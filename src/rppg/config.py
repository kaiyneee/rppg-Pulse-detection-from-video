...
class QualityConfig:
    ...
    # (9% ширины полосы) — очень высокая планка для 10-секундного окна, и
    # строже стандартного определения SNR из литературы (Wang et al., 2016),
    # где в мощность сигнала входит и 2-я гармоника (см.
    # dominant_frequency_and_snr(..., include_second_harmonic=)). НЕ менять
    # это число наугад — см. scripts/analyze_log.py (задача 1) для реального
    # распределения spectral_snr_db на конкретной камере/условиях и
